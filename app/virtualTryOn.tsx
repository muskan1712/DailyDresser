...
export default function VirtualTryOn() {
  ...
  const GEMINI_API_KEY1 = "AIzaSyBuovYeRijoy9afbkMvoqJ-MStYHzPBcG0";
  ...
  const handleTryOn = async () => {
    ...
    try {
      ...
      const garmentBase64 = await FileSystem.readAsStringAsync(
        garmentImageUri,
      ...
      const resultBase64 = data?.candidates?.[0]?.content?.parts?.find(
        (p: any) => p.inline_data,
      )?.inline_data?.data;
      if (resultBase64) {
