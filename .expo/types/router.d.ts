  ...
  export namespace ExpoRouter {
    export interface __routes<T extends string | object = string> {
      hrefInputParams:
        ...
        | { pathname: `/virtualTryOn`; params?: Router.UnknownInputParams }
      ...
      hrefOutputParams:
        ...
        | { pathname: `/upload`; params?: Router.UnknownOutputParams }
        | { pathname: `/virtualTryOn`; params?: Router.UnknownOutputParams }
      ...
      href:
        ...
        | `/virtualTryOn${`?${string}` | `#${string}` | ""}`
        | `/_sitemap${`?${string}` | `#${string}` | ""}`
        | `${"/(tabs)"}/explore${`?${string}` | `#${string}` | ""}`
        | `/explore${`?${string}` | `#${string}` | ""}`
        | `${"/(tabs)"}${`?${string}` | `#${string}` | ""}`
        | `/${`?${string}` | `#${string}` | ""}`
        | `${"/(tabs)"}/upload${`?${string}` | `#${string}` | ""}`
        | `/upload${`?${string}` | `#${string}` | ""}`
        | {
            pathname: Router.RelativePathString;
            params?: Router.UnknownInputParams;
